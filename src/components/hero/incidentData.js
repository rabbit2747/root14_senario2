...
export const HERO_TEXT = {
  ...
  hi: {
    ...
    techniqueId: 'Technique ID',
    skip: 'SKIP',
    ctaLevelTest: 'लेवल टेस्ट शुरू करें',
    login: 'लॉगिन / रजिस्टर',
  ...
  vi: {
    ...
    headerAccent: 'Phương pháp phân tích chuyên nghiệp dựa trên MITRE ATT&CK',
    subheader: 'Chuẩn bị cho các mối đe dọa tương lai bằng cách nghiên cứu quá khứ. Nâng cao kỹ năng phân loại cấp chuyên gia.',
    matrixTitle: 'Mô hình học tập cốt lõi: Ma trận sự cố MITRE ATT&CK',
    incidentCases: 'Sự cố trong quá khứ (Incident Cases)',
    incidentDesc: 'Học bằng cách phân loại các vụ tấn công mạng thực tế theo khung MITRE ATT&CK.',
    ctaCurriculum: 'Xem chương trình học',
    ctaLearnMore: 'Tìm hiểu thêm',
    techniqueId: 'Technique ID',
    skip: 'BỎ QUA',
    ctaLevelTest: 'Bắt đầu kiểm tra trình độ',
    login: 'ĐĂNG NHẬP / ĐĂNG KÝ',
    detailAttackVector: 'Vectơ tấn công',
    detailAffected: 'Đối tượng bị ảnh hưởng',
    detailTimeline: 'Dòng thời gian',
  ...
  ar: {
    ...
    headerAccent: 'تحليل احترافي قائم على إطار MITRE ATT&CK',
    subheader: 'استعد للتهديدات المستقبلية بدراسة التهديدات الماضية. طور مهارات التصنيف على مستوى الخبراء.',
    matrixTitle: 'نموذج التعلم الأساسي: مصفوفة حوادث MITRE ATT&CK',
    incidentCases: 'الحوادث السابقة (Incident Cases)',
    incidentDesc: 'تعلم من خلال تصنيف حوادث الهجمات الإلكترونية الحقيقية باستخدام إطار MITRE ATT&CK.',
    ctaCurriculum: 'عرض المنهج',
    ctaLearnMore: 'اعرف المزيد',
    techniqueId: 'Technique ID',
    skip: 'تخطي',
    ctaLevelTest: 'ابدأ اختبار المستوى',
    login: 'تسجيل الدخول / إنشاء حساب',
    detailAttackVector: 'ناقل الهجوم',
    detailAffected: 'الجهات المتضررة',
