...
const levelTestT = {
  ...
  vi: {
    outsideTitle: 'Đánh giá năng lực MITRE ATT&CK',
    outsideDesc1: 'Bộ câu hỏi thích nghi điều chỉnh độ khó theo thời gian thực,',
    outsideDesc2: 'tổng cộng 7 câu hỏi',
    outsideDesc3: '.',
    outsideDesc4: 'Trả lời đúng thì câu tiếp theo sẽ',
    outsideDesc5: 'khó hơn',
    outsideDesc6: ', trả lời sai sẽ',
    outsideDesc7: 'dễ hơn',
    outsideDesc8: 'Màn hình kết quả phân tích',
    outsideDesc9: 'biểu đồ radar điểm mạnh/điểm yếu',
    outsideDesc10: 'của bạn.',
    timerLabel: '15 giây/câu | Chỉ 1 lần thử',
    startBtn: 'Bắt đầu kiểm tra',
    backBtn: '← Quay lại trang chính',
    confirmBtn: 'Kiểm tra đáp án',
    timeExtended: 'Đoạn văn dài, thời gian gia hạn thêm',
    timeExtendedSuffix: ' giây',
    correct: 'Đúng',
    wrong: 'Sai',
    timeout: 'Hết giờ',
    levelUp: 'Tăng độ khó',
    levelDown: 'Giảm độ khó',
    levelKeep: 'Giữ nguyên cấp độ',
    levelMax: 'Giữ nguyên cấp tối đa',
    yourLevel: 'Cấp độ của bạn:',
    scorePrefix: 'Điểm tổng:',
    scoreSuffix: ' điểm',
    signupBtn: 'Bắt đầu học',
    savingLevel: 'Đang lưu cấp độ...',
    reviewBtn: 'Báo cáo chi tiết & xem đáp án sai',
    reviewBack: '← Quay lại kết quả',
    reviewTitle: 'Báo cáo chi tiết',
    myChoice: 'Lựa chọn của tôi:',
    correctAnswer: 'Đáp án đúng:',
    easterEggTitle: 'Điểm tuyệt đối!\nBạn đã được GODROOT sủng ái.',
    easterEggBtn: 'Xem kết quả',
    currRecommend: 'Khóa học gợi ý',
  },
  ar: {
    outsideTitle: 'تقييم مهارات MITRE ATT&CK',
    outsideDesc1: 'اختبار تكيّفي يضبط صعوبته بشكل فوري،',
    outsideDesc2: 'مجموع 7 أسئلة',
    outsideDesc3: '.',
    outsideDesc4: 'الإجابة الصحيحة تجعل السؤال التالي',
    outsideDesc5: 'أصعب',
    outsideDesc6: '، والخاطئة تجعله',
    outsideDesc7: 'أسهل',
    outsideDesc8: 'تحليل',
    outsideDesc9: 'مخطط الرادار للنقاط القوية والضعيفة',
    outsideDesc10: 'في شاشة النتائج.',
    timerLabel: '15 ثانية/سؤال | محاولة واحدة',
    startBtn: 'ابدأ الاختبار',
    backBtn: '← العودة للرئيسية',
    confirmBtn: 'تحقق من الإجابة',
    timeExtended: 'نص طويل، تمديد الوقت بـ',
    timeExtendedSuffix: ' ثانية',
    correct: 'صحيح',
    wrong: 'خطأ',
    timeout: 'انتهى الوقت',
    levelUp: 'ارتفاع الصعوبة',
    levelDown: 'انخفاض الصعوبة',
    levelKeep: 'الحفاظ على المستوى',
    levelMax: 'الحفاظ على أعلى مستوى',
    yourLevel: 'مستواك:',
    scorePrefix: 'الدرجة الكلية:',
    scoreSuffix: ' نقطة',
    signupBtn: 'ابدأ التعلم',
    savingLevel: 'جارٍ حفظ المستوى...',
    reviewBtn: 'تقرير مفصل ومراجعة الأخطاء',
    reviewBack: '← العودة للنتائج',
    reviewTitle: 'التقرير المفصل',
    myChoice: 'اختياري:',
    correctAnswer: 'الإجابة الصحيحة:',
    easterEggTitle: 'درجة كاملة!\nنلت رضا GODROOT.',
    easterEggBtn: 'عرض النتائج',
    currRecommend: 'الدورة المقترحة',
  },
};
