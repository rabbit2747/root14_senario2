...
const uiText = {
  ...
  vi: {
    courseSelect: 'Chọn khóa học',
    novice: 'Nhập môn',
    beginner: 'Cơ bản',
    intermediate: 'Trung cấp',
    advanced: 'Nâng cao',
    expert: 'Chuyên gia',
    noviceDesc: 'Khám phá các khái niệm cơ bản về an ninh mạng',
    beginnerDesc: 'Hiểu các khái niệm và nguyên lý hoạt động',
    intermediateDesc: 'Luyện tập kỹ thuật tấn công và phòng thủ',
    advancedDesc: 'Hoàn thiện với mô phỏng thực chiến',
    expertDesc: 'Đào tạo chuyên sâu cấp độ chuyên gia',
    chapters: 'Chương',
    minutes: 'phút',
    start: 'Bắt đầu',
    resume: 'Tiếp tục',
    review: 'Ôn lại',
    locked: 'Khóa',
    unlockNovice: 'Hoàn thành khóa nhập môn để mở khóa',
    unlockBeginner: 'Hoàn thành khóa cơ bản để mở khóa',
    unlockIntermediate: 'Hoàn thành khóa trung cấp để mở khóa',
    unlockAdvanced: 'Hoàn thành khóa nâng cao để mở khóa',
    comingSoon: 'Sắp ra mắt',
    comingSoonDesc: 'Nội dung sẽ được bổ sung sớm',
    completed: 'Hoàn thành',
    backToMatrix: 'Quay lại Matrix',
    loginRequired: 'Cần đăng nhập',
    progress: 'Tiến độ',
    notFound: 'Không tìm thấy nội dung học cho kỹ thuật này',
    estimatedTime: 'Thời gian ước tính',
  },
  ar: {
    courseSelect: 'اختر المسار',
    novice: 'مبتدئ',
    beginner: 'أساسي',
    intermediate: 'متوسط',
    advanced: 'متقدم',
    expert: 'خبير',
    noviceDesc: 'استكشف أساسيات الأمن السيبراني',
    beginnerDesc: 'افهم المفاهيم والمبادئ',
    intermediateDesc: 'تدرّب على تقنيات الهجوم والدفاع',
    advancedDesc: 'أتمِم بمحاكاة الهجمات الحقيقية',
    expertDesc: 'تدريب متخصص عميق للخبراء',
    chapters: 'فصل',
    minutes: 'د',
    start: 'ابدأ',
    resume: 'استمر',
    review: 'مراجعة',
    locked: 'مقفل',
    unlockNovice: 'أكمل مسار المبتدئ لفتحه',
    unlockBeginner: 'أكمل مسار الأساسي لفتحه',
    unlockIntermediate: 'أكمل مسار المتوسط لفتحه',
    unlockAdvanced: 'أكمل مسار المتقدم لفتحه',
    comingSoon: 'قريباً',
    comingSoonDesc: 'سيتم إضافة المحتوى قريباً',
    completed: 'مكتمل',
    backToMatrix: 'العودة إلى Matrix',
    loginRequired: 'يجب تسجيل الدخول',
    progress: 'التقدم',
    notFound: 'لم يُعثر على محتوى تعليمي لهذه التقنية',
