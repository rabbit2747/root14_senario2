...
const translations = {
  ...
  hi: {
    ...
    statsSection: 'प्लेटफ़ॉर्म आँकड़े',
    visitors: 'आगंतुक',
    finishers: 'पूर्ण',
    techniques: 'तकनीकें',
  },
  ...
  vi: {
    title: 'Trang cá nhân',
    matrixProgress: 'Tiến độ Matrix',
    completedTraining: 'Bài tập đã hoàn thành',
    goBack: 'Quay lại',
    email: 'Email',
    userId: 'ID người dùng',
    loginStatus: 'Trạng thái đăng nhập',
    loggedIn: 'Đã xác thực',
    notLoggedIn: 'Chưa xác thực',
    techniquesClicked: 'Kỹ thuật đã xem',
    totalTechniques: 'Tổng số kỹ thuật',
    noCompletedLabs: 'Chưa hoàn thành bài tập nào.',
    startTraining: 'Bắt đầu luyện tập từ Matrix!',
    profileSection: 'Thông tin hồ sơ',
    progressSection: 'Tiến độ học tập',
    labsSection: 'Lịch sử luyện tập',
    eduProgressSection: 'Tiến độ giáo dục',
    eduChapterDone: 'hoàn thành',
    eduChapterRemain: 'còn lại',
    eduNotStarted: 'Còn khóa học chưa bắt đầu',
    statsSection: 'Thống kê nền tảng',
    visitors: 'Lượt truy cập',
    finishers: 'Người hoàn thành',
    techniques: 'Số kỹ thuật',
  },
  ar: {
    title: 'صفحتي',
    matrixProgress: 'تقدم Matrix',
    ...
    loggedIn: 'موثَّق',
    notLoggedIn: 'غير موثَّق',
    techniquesClicked: 'التقنيات التي تمت مشاهدتها',
    totalTechniques: 'إجمالي التقنيات',
    noCompletedLabs: 'لم تكتمل أي تدريبات بعد.',
    startTraining: 'ابدأ التدريب من Matrix!',
    profileSection: 'معلومات الملف الشخصي',
    progressSection: 'تقدم التدريب',
    labsSection: 'سجل التدريب',
    eduProgressSection: 'تقدم التعليم',
    eduChapterDone: 'مكتمل',
    eduChapterRemain: 'متبقٍّ',
    eduNotStarted: 'توجد دورات لم تبدأ بعد',
    statsSection: 'إحصاءات المنصة',
    visitors: 'الزوار',
    finishers: 'المكتملون',
    techniques: 'عدد التقنيات',
  },
};
