...
export default {
  ...
  persona: {
    setup: 'ANRC가 EchoAgent 업데이트 관련 의심 활동을 감지했다. 의심의 원인은 ANRC가 아니라 Orion Echo의 빌드/업데이트 파이프라인이다. 당신은 외부 정찰부터 시작하여, 신뢰 관계를 타고 고객 환경의 감사 데이터에 도달한다.',
    role: '당신 — 외부 위협 행위자 (External Operator)',
  },

  story: [
    'Orion Echo Systems는 UAE의 산업·물류·연구 캠퍼스를 대상으로 모니터링 소프트웨어를 공급하는 벤더다.',
    '최근 고객사 ANRC에서 EchoAgent 업데이트와 관련된 비정상 행동이 관찰되었다.',
    '의혹의 화살은 ANRC가 아니라 Orion Echo의 공급망 자체로 향한다.',
    '당신은 공격자다. 외부 정찰에서 출발하여 빌드 파이프라인을 거쳐, 신뢰된 업데이트 채널을 통해 고객 환경의 감사 데이터에 도달한다.',
  ],
