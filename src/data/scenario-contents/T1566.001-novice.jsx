...
const T = {
  ...
  zh: {
    loc1: 'Sector 1: 电子邮件收件箱', loc2: 'Sector 2: 钓鱼识别室', loc3: 'Sector 3: 附件分析所', loc4: 'Sector 4: 警告信号检测', loc5: 'Sector 5: 应急指挥部',
    d1_1: "咳！特工{AGENT}，集中注意力。电子邮件是全球最常用的办公工具，同时也是黑客最常见的入侵途径。",
    d1_2: "是的，队长！我能看到电子邮件的5个基本组成要素——发件人、收件人、主题、正文和附件！",
    d1_3: "很好。黑客会逐一操纵这5个要素来将邮件伪装成正常邮件。从收件箱中收集关于邮件结构的线索！",
    d2_1: "找到了！发件人地址、附件、正文——我已经识别出了电子邮件的所有核心组成要素。",
    d2_2: "干得好。发件人地址是你应该首先检查的项目。根据所学内容，破解第一道密码。",
    d3_1: "现在该学习真正的威胁了。'钓鱼（Phishing）'是向不特定多数人撒网的攻击，而'鱼叉式钓鱼'则是针对特定个人的精准打击。",
    d3_2: "鱼叉式钓鱼会调查目标的姓名、职位、公司信息，然后发送定制化邮件！手段更加高明。",
    d3_3: "没错。普通钓鱼是'广撒网'的方式，而鱼叉式钓鱼就像专门为你写的信一样精心打造。去识别室收集差异线索！",
    d4_1: "证据确保！一般钓鱼与鱼叉式钓鱼的关键区别——定向调查和伪造域名都已捕获。",
    d4_2: "出色。那么说出这种精准定向攻击的确切名称。",
    d5_1: "鱼叉式钓鱼最致命的武器就是'附件'。特别是隐藏了宏的.doc、.xls文件，一打开就会自动执行恶意代码。",
    d5_2: "这里是附件分析所！到处都是包含宏的文档和伪装扩展名的可执行文件！",
    d5_3: "表面看是普通文档，里面却藏着定时炸弹。分析并收集各类危险附件的线索！",
    d6_1: "分析完成！宏文档、伪装双重扩展名的可执行文件、加密压缩文件——3种危险类型全部识别完毕。",
    d6_2: "好。现在准确指出其中最常见、最危险的那个。",
    d7_1: "了解了邮件结构和危险附件之后，现在需要学习识别可疑邮件的5个警告信号。",
    d7_2: "我注意到了'请立即确认！'这样的紧急语气、来源不明的发件人，以及语法错误！",
    d7_3: "正是如此。再加上可疑链接和意外附件，总共5个警告信号要记住。在检测区域扫描线索！",
    d8_1: "扫描完成！紧急语气、来源不明、语法错误——可疑邮件的所有警告信号都已捕获。",
    d8_2: "咳！干得好。那么找出5个警告信号中哪个不是真的。",
    d9_1: "我已经完全掌握了鱼叉式钓鱼的攻击方式。为了保护{LEADER}的组织，必须建立应对流程！",
    d9_2: "没错！收到可疑邮件时绝对不要打开附件，立即向IT安全团队报告并采取隔离措施。在应急指挥部收集线索！",
    d10_1: "所有应急系统已启动！报告渠道、隔离协议、安全意识培训全部就绪。",
    d10_2: "辛苦了，{AGENT}。今天学习的T1566.001鱼叉式钓鱼附件防御内容已记录在最终案件手册中，请仔细复习。",
    h1: "点击发件人地址（信封图标）、附件（回形针），<br>以及正文内容（显示器）。",
    h2: "找到钓鱼诱饵（警告邮件）、目标档案（身份调查），<br>以及伪造域名（地球仪）。",
    h3: "找到宏文档（警告文件）、伪装可执行文件（终端），<br>以及压缩炸弹（锁）。",
    h4: "找到紧急语气（警告三角形）、来源不明（眼睛图标），<br>以及语法错误（放大镜）。",
    h5: "找到报告系统（盾牌）、隔离措施（锁），<br>以及安全培训（用户认证）。",
    c_sender_t: "发件人地址", c_sender_m: "电子邮件中应首先检查的要素。黑客使用与真实公司相似的虚假地址（如：support@g00gle.com）来伪装信任。",
    c_attach_t: "附件", c_attach_m: "附加在电子邮件中的文件。看起来像正常文档，但可能隐藏恶意软件——最需要警惕的要素。",
    c_body_t: "邮件正文", c_body_m: "电子邮件的主要信息区域。黑客使用紧急语气或恐吓性措辞诱导用户打开附件。",
    c_hook_t: "钓鱼诱饵", c_hook_m: "向不特定多数人批量发送相同虚假邮件的攻击。使用'您的账户已被冻结'等恐吓信息诱导点击。",
    c_target_t: "目标档案", c_target_m: "鱼叉式钓鱼攻击者通过社交媒体、公司网站等调查目标的姓名、职位、同事关系来编写定制化邮件。",
    c_domain_t: "伪造域名", c_domain_m: "与真实公司域名几乎相同的假域名。例如：microsoft.com → micros0ft.com，只改一个字符就足以欺骗。",
    c_macro_t: "宏文档", c_macro_m: "隐藏在Word(.doc)或Excel(.xls)文件中的自动执行脚本。点击'启用内容'后恶意代码立即执行。",
    c_exe_t: "伪装可执行文件", c_exe_m: "使用双重扩展名（如：report.pdf.exe）伪装成文档文件，实际上是恶意可执行程序。",
    c_zip_t: "压缩炸弹", c_zip_m: "加密的ZIP/RAR文件可绕过安全扫描。邮件正文中提供密码，诱导用户自行解压。",
    c_urgent_t: "紧急语气", c_urgent_m: "'请立即确认'、'账户冻结警告'等——营造紧迫感，让用户来不及思考就打开附件或点击链接的手法。",
    c_unknown_t: "来源不明", c_unknown_m: "从未联系过的发件人，或者认识名字但邮箱地址不同的人。务必用肉眼直接确认地址。",
    c_grammar_t: "语法错误", c_grammar_m: "声称来自官方机构的邮件中存在别扭的语法、错别字或翻译腔的句子，很可能是钓鱼邮件。",
    c_report_t: "报告系统", c_report_m: "发现可疑邮件时，首先应向IT安全团队或管理员报告。不要自行判断——交给专家处理。",
    c_quarantine_t: "隔离措施", c_quarantine_m: "不要打开可疑邮件——立即隔离（移至垃圾邮件或删除）。如果已经打开，立即断开网络并通知安全团队。",
    c_aware_t: "安全培训", c_aware_m: "定期的安全意识培训和模拟钓鱼演练是防御鱼叉式钓鱼最有效的方法。人是最后一道防线。",
    p1_title: "电子邮件的组成要素", p1_desc: "<b>构成电子邮件的5个要素</b>（发件人、收件人、主题、正文、附件）中<b>不属于其中的</b>是？",
    p1_opts: ["发件人 / 收件人", "主题 / 正文", "附件", "Cookie"],
    p2_title: "精准定向攻击", p2_desc: "不是针对不特定多数，而是<b>精确瞄准特定个人或组织</b>发送定制化邮件的定向攻击叫什么？",
    p2_opts: ["DDoS攻击", "鱼叉式钓鱼 (Spear Phishing)", "SQL注入", "跨站脚本攻击 (XSS)"],
    p3_title: "最危险的附件", p3_desc: "最危险的附件类型，其中<b>文档内隐藏的代码（宏）会自动执行</b>并安装恶意软件的是？",
    p3_opts: [".txt（文本文件）", ".jpg（图片文件）", "包含宏的 .doc / .xls", ".mp3（音频文件）"],
    p4_title: "警告信号辨别", p4_desc: "可疑邮件的<b>5个警告信号</b>（紧急语气、来源不明、可疑链接、意外附件、语法错误）中<b>不属于其中的</b>是？",
    p4_opts: ["紧急语气要求立即行动", "来源不明的发件人", "来自公司官方域名的正常邮件", "别扭的语法和错别字"],
    p5_title: "最优先应对行动", p5_desc: "收到疑似鱼叉式钓鱼邮件时，<b>应该首先做的</b>是什么？",
    p5_opts: ["打开附件查看内容", "立即向IT安全团队报告", "回复发件人确认", "转发给同事征求意见"],
    teamLeader: '队长', agent: '特工', secRate: '确保率', certReport: '结业报告',
    analysisReport: '分析报告', freeMode: '（自由探索模式）',
    proceed: '继续', next: '下一步', closeWindow: '关闭窗口', saveData: '保存数据',
    inventory: '收集数据（Inventory）', noClues: '尚未收集到线索。',
    prevTab: '◀ 上一页', nextTab: '下一页 ▶',
    rTab1: "1. 电子邮件基本结构", rTab2: "2. 钓鱼与鱼叉式钓鱼", rTab3: "3. 危险附件",
    rTab4: "4. 5个警告信号", rTab5: "5. 基本应对方法", rTab6: "6. 最终训练结业",
    r1_h: "电子邮件基本结构",
    r1_ch1: "Ch 1. 电子邮件的5个组成要素",
    r1_ch1_p: '电子邮件由<span class="text-white bg-white/10 px-1 rounded">发件人、收件人、主题、正文、附件</span>5个要素组成。黑客操纵所有这些要素来伪装成正常邮件。',
    r1_ch2: "Ch 2. 发件人地址的重要性",
    r1_ch2_l1: '发件人地址是收到邮件时<span class="text-white bg-white/10 px-1 rounded">应首先检查</span>的项目。',
    r1_ch2_l2: "黑客使用与真实公司相似的虚假域名（如：@g00gle.com）来伪装信任。",
    r2_h: "钓鱼与鱼叉式钓鱼",
    r2_ch3: "Ch 3. 一般钓鱼的特征",
    r2_ch3_p: '钓鱼（Phishing）是向<span class="text-white bg-white/10 px-1 rounded">不特定多数</span>批量发送相同虚假邮件的攻击。使用"您的账户已被冻结"等恐吓信息诱导点击。',
    r2_ch4: "Ch 4. 鱼叉式钓鱼的精准定向",
    r2_ch4_l1: '鱼叉式钓鱼会事先调查目标的姓名、职位、公司、同事关系来编写<span class="text-white bg-white/10 px-1 rounded">定制化邮件</span>。',
    r2_ch4_l2: "伪装成真实同事或合作伙伴发送的邮件，成功率远高于一般钓鱼。",
    r3_h: "危险附件",
    r3_ch5: "Ch 5. 宏文档的危险性",
    r3_ch5_p: '隐藏在Word(.doc)或Excel(.xls)文件中的<span class="text-white bg-white/10 px-1 rounded">宏（自动执行脚本）</span>会在点击"启用内容"按钮的瞬间安装恶意软件。',
    r3_ch6: "Ch 6. 按文件扩展名的危险等级",
    r3_ch6_l1: "包含宏的文档 (.doc, .xls, .ppt) — 最常见的攻击向量",
    r3_ch6_l2: "双重扩展名可执行文件 (report.pdf.exe) — 伪装成文档",
    r3_ch6_l3: "加密压缩文件 (.zip, .rar) — 绕过安全扫描",
    r3_ch6_l4: "脚本文件 (.js, .vbs, .bat) — 直接执行代码",
    r4_h: "5个警告信号",
    r4_ch7: "Ch 7. 紧急语气与来源不明",
    r4_ch7_l1: '<span class="text-white bg-white/10 px-1 rounded">紧急语气</span>："请立即确认"、"账户冻结"等，制造恐慌使判断力下降。',
    r4_ch7_l2: '<span class="text-white bg-white/10 px-1 rounded">来源不明</span>：不认识的发件人，或者认识名字但邮箱地址与平时不同。',
    r4_ch8: "Ch 8. 链接、附件、语法错误",
    r4_ch8_l1: '<span class="text-white bg-white/10 px-1 rounded">可疑链接</span>：鼠标悬停时会显示与显示不同的实际URL。',
    r4_ch8_l2: '<span class="text-white bg-white/10 px-1 rounded">意外附件</span>：附加了您未请求的文件。',
    r4_ch8_l3: '<span class="text-white bg-white/10 px-1 rounded">语法错误</span>：声称来自官方机构的邮件中有错别字或别扭的翻译腔，应怀疑为钓鱼。',
    r5_h: "基本应对方法",
    r5_ch9: "Ch 9. 报告与隔离",
    r5_ch9_l1: '可疑邮件<span class="text-white bg-white/10 px-1 rounded">绝对不要打开附件</span>，立即向IT安全团队报告。',
    r5_ch9_l2: "如果已经打开，立即断开网络、更改密码，并遵循安全团队的指示。",
    r5_ch10: "Ch 10. 安全意识培训的重要性",
    r5_ch10_l1: '定期的<span class="text-white bg-white/10 px-1 rounded">安全意识培训</span>和模拟钓鱼演练是最有效的防御手段。',
    r5_ch10_l2: '归根结底，<span class="text-white bg-white/10 px-1 rounded">人是最后一道防线</span>。',
    r6_title: "训练结业！",
    r6_desc: "从电子邮件基本结构到应对方法，<br/>您已出色完成T1566.001<br/>鱼叉式钓鱼附件基础课程。",
    r6_grade: "最终评级：",
    r6_labBtn: "前往实验室 🚀",
    r6_freeHint: "（关闭此窗口可自由重新探索各区域）",
  },
  hi: {
    loc1: 'Sector 1: ईमेल इनबॉक्स', loc2: 'Sector 2: फ़िशिंग विश्लेषण कक्ष', loc3: 'Sector 3: अटैचमेंट विश्लेषण केंद्र', loc4: 'Sector 4: चेतावनी संकेत पहचान', loc5: 'Sector 5: प्रतिक्रिया मुख्यालय',
    d1_1: "ध्यान दो! एजेंट {AGENT}, ध्यान केंद्रित करो। ईमेल दुनिया में सबसे अधिक इस्तेमाल होने वाला कार्यालयीन उपकरण है — और हैकर्स का सबसे आम घुसपैठ मार्ग भी।",
    d1_2: "जी हाँ, टीम लीडर! मुझे ईमेल के 5 बुनियादी घटक दिख रहे हैं — प्रेषक, प्राप्तकर्ता, विषय, मुख्य भाग और अटैचमेंट!",
    d1_3: "अच्छा। हैकर्स इन 5 घटकों में से हर एक में हेरफेर करके ईमेल को वैध दिखाते हैं। इनबॉक्स से ईमेल संरचना के सुराग इकट्ठा करो!",
    d2_1: "मिल गए! प्रेषक का पता, अटैचमेंट, मुख्य भाग — मैंने ईमेल के सभी प्रमुख घटकों की पहचान कर ली।",
    d2_2: "शाबाश। प्रेषक का पता सबसे पहले जाँचने वाली चीज़ है। जो सीखा है उसके आधार पर पहला कोड हल करो।",
    d3_1: "अब असली खतरे सीखने का समय है। 'फ़िशिंग (Phishing)' अनिश्चित बहुसंख्यकों पर जाल फेंकने वाला हमला है, जबकि 'स्पीयर फ़िशिंग' विशिष्ट व्यक्तियों पर सटीक निशाना है।",
    d3_2: "स्पीयर फ़िशिंग लक्ष्य का नाम, पद, कंपनी की जानकारी तक की जाँच करके अनुकूलित ईमेल भेजती है! यह कहीं अधिक चालाक है।",
    d3_3: "बिल्कुल सही। सामान्य फ़िशिंग 'कोई भी फँसे' शैली है, लेकिन स्पीयर फ़िशिंग ऐसे बनाई जाती है जैसे सिर्फ तुम्हारे लिए लिखी गई हो। विश्लेषण कक्ष में अंतर के सुराग इकट्ठा करो!",
    d4_1: "सबूत सुरक्षित! सामान्य फ़िशिंग और स्पीयर फ़िशिंग का निर्णायक अंतर — लक्षित अनुसंधान और जाली डोमेन सब पकड़ लिए।",
    d4_2: "उत्कृष्ट। अब इस सटीक लक्षित हमले का सही नाम बताओ।",
    d5_1: "स्पीयर फ़िशिंग का सबसे घातक हथियार 'अटैचमेंट' है। विशेष रूप से मैक्रो छुपे .doc, .xls फ़ाइलें खोलते ही मैलवेयर अपने आप चल जाता है।",
    d5_2: "यह अटैचमेंट विश्लेषण केंद्र है! मैक्रो वाले दस्तावेज़ और नकली एक्सटेंशन वाली एक्ज़ीक्यूटेबल फ़ाइलें भरी पड़ी हैं!",
    d5_3: "ऊपर से साधारण दस्तावेज़ दिखते हैं, लेकिन अंदर टाइम बम छिपे हैं। खतरनाक अटैचमेंट के प्रकारवार सुराग विश्लेषित करो और इकट्ठा करो!",
    d6_1: "विश्लेषण पूर्ण! मैक्रो दस्तावेज़, प्रच्छन्न दोहरे एक्सटेंशन एक्ज़ीक्यूटेबल, पासवर्ड-संरक्षित संपीड़ित फ़ाइलें — तीनों खतरनाक प्रकार पहचान लिए।",
    d6_2: "अच्छा। अब इनमें से सबसे आम और खतरनाक की सही पहचान करो।",
    d7_1: "ईमेल की संरचना और खतरनाक अटैचमेंट समझ लिए, अब संदिग्ध ईमेल पहचानने के 5 चेतावनी संकेत सीखने हैं।",
    d7_2: "'अभी तुरंत जाँच करें!' जैसा तात्कालिक लहजा, अज्ञात प्रेषक, और व्याकरण की त्रुटियाँ दिख रही हैं!",
    d7_3: "बिल्कुल वही। इसमें संदिग्ध लिंक और अप्रत्याशित अटैचमेंट जोड़ दो, कुल 5 चेतावनी संकेत याद रखो। पहचान क्षेत्र में सुराग स्कैन करो!",
    d8_1: "स्कैन पूर्ण! तात्कालिक लहजा, अज्ञात स्रोत, व्याकरण त्रुटियाँ — संदिग्ध ईमेल के सभी चेतावनी संकेत पकड़ लिए।",
    d8_2: "ध्यान दो! शाबाश। अब 5 चेतावनी संकेतों में से जो असली नहीं है उसे पहचानो।",
    d9_1: "मैंने स्पीयर फ़िशिंग की हमला विधि पूरी तरह समझ ली है। {LEADER} के संगठन की रक्षा के लिए प्रतिक्रिया प्रक्रिया स्थापित करनी होगी!",
    d9_2: "सही! संदिग्ध ईमेल मिलने पर कभी भी अटैचमेंट मत खोलो, तुरंत IT सुरक्षा टीम को रिपोर्ट करो और क्वारंटाइन कार्रवाई करो। प्रतिक्रिया मुख्यालय में सुराग प्राप्त करो!",
    d10_1: "सभी प्रतिक्रिया प्रणालियाँ सक्रिय! रिपोर्टिंग चैनल, क्वारंटाइन प्रोटोकॉल और सुरक्षा जागरूकता प्रशिक्षण सब तैयार हैं।",
    d10_2: "अच्छा काम किया, {AGENT}। आज सीखी गई T1566.001 स्पीयर फ़िशिंग अटैचमेंट रक्षा सामग्री अंतिम केस नोटबुक में दर्ज कर दी है, ध्यान से दोहराना।",
    h1: "प्रेषक का पता (लिफ़ाफ़ा आइकन), अटैचमेंट (क्लिप),<br>और मुख्य भाग (मॉनिटर) पर क्लिक करो।",
    h2: "फ़िशिंग चारा (चेतावनी मेल), लक्ष्य प्रोफ़ाइल (पहचान जाँच),<br>और जाली डोमेन (ग्लोब) खोजो।",
    h3: "मैक्रो दस्तावेज़ (चेतावनी फ़ाइल), प्रच्छन्न एक्ज़ीक्यूटेबल (टर्मिनल),<br>और संपीड़न बम (ताला) खोजो।",
    h4: "तात्कालिक लहजा (चेतावनी त्रिभुज), अज्ञात स्रोत (आँख आइकन),<br>और व्याकरण त्रुटि (आवर्धक लेंस) खोजो।",
    h5: "रिपोर्टिंग सिस्टम (ढाल), क्वारंटाइन कार्रवाई (ताला),<br>और सुरक्षा प्रशिक्षण (उपयोगकर्ता सत्यापन) खोजो।",
    c_sender_t: "प्रेषक का पता", c_sender_m: "ईमेल में सबसे पहले जाँचने वाला तत्व। हैकर्स असली कंपनियों से मिलते-जुलते नकली पते (जैसे: support@g00gle.com) से विश्वास का मुखौटा लगाते हैं।",
    c_attach_t: "अटैचमेंट", c_attach_m: "ईमेल के साथ जुड़ी फ़ाइलें। सामान्य दस्तावेज़ जैसी दिखती हैं लेकिन मैलवेयर छिपा हो सकता है — सबसे सतर्कता वाला तत्व।",
    c_body_t: "मुख्य भाग", c_body_m: "ईमेल का प्रमुख संदेश क्षेत्र। हैकर्स तात्कालिक लहजे या भय पैदा करने वाली भाषा से उपयोगकर्ता को अटैचमेंट खोलने के लिए प्रेरित करते हैं।",
    c_hook_t: "फ़िशिंग चारा", c_hook_m: "अनिश्चित बहुसंख्यकों को एक जैसे नकली ईमेल बड़ी मात्रा में भेजने वाला हमला। 'आपका खाता निलंबित कर दिया गया है' जैसे डरावने संदेश से क्लिक करवाता है।",
    c_target_t: "लक्ष्य प्रोफ़ाइल", c_target_m: "स्पीयर फ़िशिंग हमलावर सोशल मीडिया, कंपनी वेबसाइट आदि से लक्ष्य का नाम, पद, सहकर्मी संबंध जाँचकर अनुकूलित ईमेल तैयार करते हैं।",
    c_domain_t: "जाली डोमेन", c_domain_m: "असली कंपनी के डोमेन से लगभग समान दिखने वाला नकली डोमेन। उदाहरण: microsoft.com → micros0ft.com, एक अक्षर बदलना भी धोखा देने के लिए काफ़ी है।",
    c_macro_t: "मैक्रो दस्तावेज़", c_macro_m: "Word(.doc) या Excel(.xls) फ़ाइलों में छिपी स्वचालित निष्पादन स्क्रिप्ट। 'सामग्री सक्षम करें' क्लिक करने पर मैलवेयर तुरंत इंस्टॉल हो जाता है।",
    c_exe_t: "प्रच्छन्न एक्ज़ीक्यूटेबल", c_exe_m: "दोहरे एक्सटेंशन (जैसे: report.pdf.exe) का उपयोग करके दस्तावेज़ फ़ाइल जैसा दिखता है, लेकिन वास्तव में दुर्भावनापूर्ण प्रोग्राम है।",
    c_zip_t: "संपीड़न बम", c_zip_m: "पासवर्ड-संरक्षित ZIP/RAR फ़ाइलें सुरक्षा स्कैनिंग को बायपास करती हैं। ईमेल में पासवर्ड दिया जाता है ताकि उपयोगकर्ता खुद निकालें।",
    c_urgent_t: "तात्कालिक लहजा", c_urgent_m: "'तुरंत जाँच करें', 'खाता निलंबन चेतावनी' आदि — ऐसी तात्कालिकता पैदा करते हैं कि उपयोगकर्ता सोचे बिना अटैचमेंट खोल दे या लिंक क्लिक कर दे।",
    c_unknown_t: "अज्ञात स्रोत", c_unknown_m: "कभी संपर्क न किया हो ऐसा प्रेषक, या नाम जानते हों पर ईमेल पता अलग हो। पता हमेशा अपनी आँखों से सीधे सत्यापित करें।",
    c_grammar_t: "व्याकरण त्रुटि", c_grammar_m: "आधिकारिक संस्था से आने का दावा करने वाले ईमेल में अटपटा व्याकरण, टाइपो या अनुवाद जैसी भाषा हो तो फ़िशिंग की संभावना अधिक है।",
    c_report_t: "रिपोर्टिंग सिस्टम", c_report_m: "संदिग्ध ईमेल मिलने पर सबसे पहले IT सुरक्षा टीम या प्रशासक को रिपोर्ट करें। अकेले फ़ैसला न लें — विशेषज्ञों पर छोड़ें।",
    c_quarantine_t: "क्वारंटाइन कार्रवाई", c_quarantine_m: "संदिग्ध ईमेल न खोलें — तुरंत क्वारंटाइन करें (स्पैम में डालें या हटाएँ)। अगर पहले ही खोल दिया है तो नेटवर्क काटें और सुरक्षा टीम को सूचित करें।",
    c_aware_t: "सुरक्षा प्रशिक्षण", c_aware_m: "नियमित सुरक्षा जागरूकता प्रशिक्षण और मॉक फ़िशिंग अभ्यास स्पीयर फ़िशिंग से बचाव का सबसे प्रभावी तरीका है। इंसान ही अंतिम रक्षा पंक्ति है।",
    p1_title: "ईमेल के घटक", p1_desc: "<b>ईमेल के 5 घटकों</b> (प्रेषक, प्राप्तकर्ता, विषय, मुख्य भाग, अटैचमेंट) में <b>शामिल नहीं</b> है?",
    p1_opts: ["प्रेषक / प्राप्तकर्ता", "विषय / मुख्य भाग", "अटैचमेंट", "कुकी (Cookie)"],
    p2_title: "सटीक लक्षित हमला", p2_desc: "अनिश्चित बहुसंख्यकों के बजाय <b>विशिष्ट व्यक्तियों या संगठनों को सटीक निशाना</b> बनाकर अनुकूलित ईमेल भेजने वाले हमले का नाम क्या है?",
    p2_opts: ["DDoS हमला", "स्पीयर फ़िशिंग (Spear Phishing)", "SQL इंजेक्शन", "क्रॉस-साइट स्क्रिप्टिंग (XSS)"],
    p3_title: "सबसे खतरनाक अटैचमेंट", p3_desc: "सबसे खतरनाक अटैचमेंट प्रकार, जिसमें <b>दस्तावेज़ में छिपा कोड (मैक्रो) स्वचालित रूप से चलता है</b> और मैलवेयर इंस्टॉल करता है?",
    p3_opts: [".txt (टेक्स्ट फ़ाइल)", ".jpg (इमेज फ़ाइल)", "मैक्रो सहित .doc / .xls", ".mp3 (ऑडियो फ़ाइल)"],
    p4_title: "चेतावनी संकेत पहचान", p4_desc: "संदिग्ध ईमेल के <b>5 चेतावनी संकेतों</b> (तात्कालिक लहजा, अज्ञात स्रोत, संदिग्ध लिंक, अप्रत्याशित अटैचमेंट, व्याकरण त्रुटि) में <b>शामिल नहीं</b> है?",
    p4_opts: ["तात्कालिक लहजे में तुरंत कार्रवाई की माँग", "अज्ञात स्रोत का प्रेषक", "कंपनी के आधिकारिक डोमेन से आया सामान्य मेल", "अटपटा व्याकरण और टाइपो"],
    p5_title: "सर्वोच्च प्राथमिकता प्रतिक्रिया", p5_desc: "जब स्पीयर फ़िशिंग संदिग्ध ईमेल प्राप्त हो, तो <b>सबसे पहले क्या करना चाहिए</b>?",
    p5_opts: ["अटैचमेंट खोलकर सामग्री जाँचें", "IT सुरक्षा टीम को तुरंत रिपोर्ट करें", "प्रेषक को जवाब देकर पुष्टि करें", "सहकर्मियों को फ़ॉरवर्ड करके राय लें"],
    teamLeader: 'टीम लीडर', agent: 'एजेंट', secRate: 'सुरक्षा दर', certReport: 'पूर्णता रिपोर्ट',
    analysisReport: 'विश्लेषण रिपोर्ट', freeMode: '(स्वतंत्र अन्वेषण मोड)',
    proceed: 'आगे बढ़ें', next: 'अगला', closeWindow: 'विंडो बंद करें', saveData: 'डेटा सहेजें',
    inventory: 'संग्रहित डेटा (Inventory)', noClues: 'अभी तक कोई सुराग एकत्र नहीं हुआ।',
    prevTab: '◀ पिछला', nextTab: 'अगला ▶',
    rTab1: "1. ईमेल की बुनियादी संरचना", rTab2: "2. फ़िशिंग और स्पीयर फ़िशिंग", rTab3: "3. खतरनाक अटैचमेंट",
    rTab4: "4. 5 चेतावनी संकेत", rTab5: "5. बुनियादी प्रतिक्रिया विधि", rTab6: "6. अंतिम प्रशिक्षण पूर्णता",
    r1_h: "ईमेल की बुनियादी संरचना",
    r1_ch1: "Ch 1. ईमेल के 5 घटक",
    r1_ch1_p: 'ईमेल <span class="text-white bg-white/10 px-1 rounded">प्रेषक, प्राप्तकर्ता, विषय, मुख्य भाग, अटैचमेंट</span> — 5 घटकों से बना होता है। हैकर्स इन सभी में हेरफेर करके सामान्य ईमेल का मुखौटा लगाते हैं।',
    r1_ch2: "Ch 2. प्रेषक के पते का महत्व",
    r1_ch2_l1: 'प्रेषक का पता ईमेल प्राप्त होने पर <span class="text-white bg-white/10 px-1 rounded">सबसे पहले जाँचने</span> वाली चीज़ है।',
    r1_ch2_l2: "हैकर्स असली कंपनियों से मिलते-जुलते नकली डोमेन (जैसे: @g00gle.com) से विश्वास का मुखौटा लगाते हैं।",
    r2_h: "फ़िशिंग और स्पीयर फ़िशिंग",
    r2_ch3: "Ch 3. सामान्य फ़िशिंग की विशेषताएँ",
    r2_ch3_p: 'फ़िशिंग (Phishing) <span class="text-white bg-white/10 px-1 rounded">अनिश्चित बहुसंख्यकों</span> को एक जैसे नकली ईमेल बड़ी मात्रा में भेजने वाला हमला है। "आपका खाता निलंबित कर दिया गया है" जैसे डरावने संदेश से क्लिक करवाता है।',
    r2_ch4: "Ch 4. स्पीयर फ़िशिंग का सटीक लक्ष्यीकरण",
    r2_ch4_l1: 'स्पीयर फ़िशिंग लक्ष्य का नाम, पद, कंपनी, सहकर्मी संबंध पहले से जाँचकर <span class="text-white bg-white/10 px-1 rounded">अनुकूलित ईमेल</span> तैयार करती है।',
    r2_ch4_l2: "असली सहकर्मी या व्यापार साझेदार से भेजा गया प्रतीत होता है, इसलिए सामान्य फ़िशिंग से कहीं अधिक सफल होता है।",
    r3_h: "खतरनाक अटैचमेंट",
    r3_ch5: "Ch 5. मैक्रो दस्तावेज़ का खतरा",
    r3_ch5_p: 'Word(.doc) या Excel(.xls) फ़ाइलों में छिपे <span class="text-white bg-white/10 px-1 rounded">मैक्रो (स्वचालित निष्पादन स्क्रिप्ट)</span> "सामग्री सक्षम करें" बटन क्लिक करते ही मैलवेयर इंस्टॉल कर देते हैं।',
    r3_ch6: "Ch 6. फ़ाइल एक्सटेंशन अनुसार खतरे का स्तर",
    r3_ch6_l1: "मैक्रो सहित दस्तावेज़ (.doc, .xls, .ppt) — सबसे आम हमला वेक्टर",
    r3_ch6_l2: "दोहरे एक्सटेंशन एक्ज़ीक्यूटेबल (report.pdf.exe) — दस्तावेज़ के रूप में प्रच्छन्न",
    r3_ch6_l3: "पासवर्ड-संरक्षित संपीड़ित फ़ाइलें (.zip, .rar) — सुरक्षा स्कैन बायपास",
    r3_ch6_l4: "स्क्रिप्ट फ़ाइलें (.js, .vbs, .bat) — सीधे कोड निष्पादन",
    r4_h: "5 चेतावनी संकेत",
    r4_ch7: "Ch 7. तात्कालिक लहजा और अज्ञात स्रोत",
    r4_ch7_l1: '<span class="text-white bg-white/10 px-1 rounded">तात्कालिक लहजा</span>: "तुरंत जाँच करें", "खाता निलंबन" आदि — भय पैदा करके निर्णय क्षमता कमज़ोर करता है।',
    r4_ch7_l2: '<span class="text-white bg-white/10 px-1 rounded">अज्ञात स्रोत</span>: अनजान प्रेषक, या नाम जानते हों पर ईमेल पता सामान्य से भिन्न हो।',
    r4_ch8: "Ch 8. लिंक, अटैचमेंट, व्याकरण त्रुटि",
    r4_ch8_l1: '<span class="text-white bg-white/10 px-1 rounded">संदिग्ध लिंक</span>: माउस रखने पर वास्तविक URL प्रदर्शित से भिन्न दिखता है।',
    r4_ch8_l2: '<span class="text-white bg-white/10 px-1 rounded">अप्रत्याशित अटैचमेंट</span>: ऐसी फ़ाइलें जो आपने माँगी नहीं थीं, अटैच की गई हैं।',
    r4_ch8_l3: '<span class="text-white bg-white/10 px-1 rounded">व्याकरण त्रुटि</span>: आधिकारिक संस्था के ईमेल में टाइपो या अटपटी अनुवाद शैली हो तो फ़िशिंग का संदेह करें।',
    r5_h: "बुनियादी प्रतिक्रिया विधि",
    r5_ch9: "Ch 9. रिपोर्ट और क्वारंटाइन",
    r5_ch9_l1: 'संदिग्ध ईमेल का <span class="text-white bg-white/10 px-1 rounded">अटैचमेंट कभी न खोलें</span>, तुरंत IT सुरक्षा टीम को रिपोर्ट करें।',
    r5_ch9_l2: "अगर पहले ही खोल दिया है तो तुरंत नेटवर्क काटें, पासवर्ड बदलें और सुरक्षा टीम के निर्देशों का पालन करें।",
    r5_ch10: "Ch 10. सुरक्षा जागरूकता प्रशिक्षण का महत्व",
    r5_ch10_l1: 'नियमित <span class="text-white bg-white/10 px-1 rounded">सुरक्षा जागरूकता प्रशिक्षण</span> और मॉक फ़िशिंग अभ्यास सबसे प्रभावी रक्षा उपाय हैं।',
    r5_ch10_l2: 'अंततः <span class="text-white bg-white/10 px-1 rounded">इंसान ही अंतिम रक्षा पंक्ति है</span>।',
    r6_title: "प्रशिक्षण पूर्ण!",
    r6_desc: "ईमेल की बुनियादी संरचना से लेकर प्रतिक्रिया विधि तक,<br/>T1566.001 स्पीयर फ़िशिंग अटैचमेंट<br/>बुनियादी पाठ्यक्रम उत्कृष्ट रूप से पूर्ण किया।",
    r6_grade: "अंतिम ग्रेड:",
    r6_labBtn: "प्रयोगशाला में जाएँ 🚀",
    r6_freeHint: "(यह विंडो बंद करके प्रत्येक सेक्टर का स्वतंत्र रूप से पुन: अन्वेषण कर सकते हैं)",
  },
};
