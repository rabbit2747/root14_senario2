...
const T = {
  ...
  zh: {
    loc1: 'Sector 1: 邮件服务器室', loc2: 'Sector 2: 认证验证所', loc3: 'Sector 3: 附件解剖室', loc4: 'Sector 4: APT追踪室', loc5: 'Sector 5: 防御指挥所',
    d1_1: "咳咳！特工{AGENT}，今天的任务是剖析鱼叉式网络钓鱼攻击的整体结构。首先需要了解电子邮件是如何传输的。",
    d1_2: "是的，队长！这里是邮件服务器室。我听说SMTP协议是电子邮件传输的核心通道。",
    d1_3: "没错。黑客利用SMTP通道发送带有恶意附件的邮件。收集邮件传输过程中的3个关键线索！",
    d2_1: "找到了！电子邮件从SMTP服务器出发，经过多个中继服务器到达收件人。",
    d2_2: "干得好。现在说出这个传输过程中使用的核心协议名称。",
    d3_1: "了解了邮件传输路径后，现在来看看过滤'伪造发件人'的认证体系。",
    d3_2: "发件人地址可以伪造？那怎么确认是谁发的呢？",
    d3_3: "这就是SPF、DKIM、DMARC三层认证防护的作用。在验证所中获取每种认证技术的线索！",
    d4_1: "扫描完成！SPF验证发件IP，DKIM验证邮件内容完整性，DMARC综合两者进行判定。",
    d4_2: "完全正确。那么请说出验证发件域名IP的第一道防护名称。",
    d5_1: "即使通过了认证，邮件'内部'还隐藏着武器。让我们解剖附件的内部结构。",
    d5_2: "在这个解剖室里，我看到了MIME头部、Base64编码的附件，还有……隐藏在文档中的VBA宏！",
    d5_3: "没错，黑客在Word和Excel文档中植入恶意VBA宏。彻底解剖附件结构！",
    d6_1: "证据已确保！宏激活后会从外部服务器下载额外的恶意代码。",
    d6_2: "就是这样。说出隐藏在文档文件中并自动执行的恶意脚本的确切名称。",
    d7_1: "现在需要揭露实际使用这些武器的幕后黑手。他们是国家支持的APT组织。",
    d7_2: "APT28（俄罗斯）、Lazarus（朝鲜）……这些都是常用鱼叉式钓鱼附件的组织！",
    d7_3: "他们在发送定制钓鱼邮件之前会彻底调查目标的工作环境。追踪C2通道并获取线索！",
    d8_1: "追踪完成！我捕获了各APT组织精确瞄准特定行业和国家的模式。",
    d8_2: "好。准确说出被指为SolarWinds供应链攻击幕后的俄罗斯APT组织名称。",
    d9_1: "已掌握敌方所有战术。现在需要为{LEADER}的组织构建多层防御体系！",
    d9_2: "对，用邮件网关进行第一层过滤，在沙箱中安全分析可疑文件，并通过用户培训建立最后的防线！",
    d10_1: "所有防御系统已启动！网关、沙箱和员工培训——三重防线已就位。",
    d10_2: "等一下，让我最后确认一下在隔离虚拟环境中安全执行和分析可疑文件的技术名称。",
    d11_1: "完美，{AGENT}。从SMTP到认证、宏、APT再到多层防御——你已经精通了鱼叉式钓鱼的一切。",
    d11_2: "谢谢您，{LEADER}！我会把今天学到的内容整理到案件手册中。",
    h1: "找到发送邮件的SMTP服务器、中继转发的服务器、<br>以及通信使用的端口号。",
    h2: "找到验证发件IP的SPF记录、检查数字签名的DKIM、<br>以及决定策略的DMARC。",
    h3: "找到定义邮件结构的MIME头部、隐藏在文档中的VBA宏、<br>以及转换附件的Base64编码。",
    h4: "找到俄罗斯APT28的情报、朝鲜Lazarus的痕迹、<br>以及感染后接收命令的C2通道。",
    h5: "找到过滤恶意邮件的邮件网关、分析可疑文件的沙箱、<br>以及培养人员判断力的用户培训。",
    c_smtp_t: "SMTP服务器", c_smtp_m: "Simple Mail Transfer Protocol——将电子邮件从发送方传递到接收方服务器的核心协议。使用端口25（默认）和587（安全传输）。",
    c_relay_t: "邮件中继", c_relay_m: "电子邮件从发送MTA到接收MTA经过多个中继(Relay)服务器。每个服务器在Received头部留下经由记录。",
    c_port_t: "端口25/587", c_port_m: "SMTP默认使用端口25，STARTTLS加密传输时使用端口587。黑客可能利用开放中继。",
    c_spf_t: "SPF记录", c_spf_m: "Sender Policy Framework——将发送域DNS中注册的允许IP列表与实际发件IP进行比对以检测伪造。",
    c_dkim_t: "DKIM签名", c_dkim_m: "DomainKeys Identified Mail——发送服务器为邮件添加数字签名，接收方使用DNS公钥验证完整性。",
    c_dmarc_t: "DMARC策略", c_dmarc_m: "Domain-based Message Authentication——综合SPF和DKIM结果应用reject/quarantine/none策略并生成报告。",
    c_mime_t: "MIME头部", c_mime_m: "Multipurpose Internet Mail Extensions——定义电子邮件正文类型、附件边界(boundary)和编码方式的结构。",
    c_vba_t: "VBA宏", c_vba_m: "Visual Basic for Applications——嵌入Word/Excel文档中，点击'启用内容'时自动执行的脚本。是黑客最常用的初始入侵向量之一。",
    c_base64_t: "Base64编码", c_base64_m: "将二进制附件转换为文本以通过SMTP传输的编码方式。恶意文件也以此形式包含在邮件中。",
    c_apt28_t: "APT28情报", c_apt28_m: "俄罗斯GRU旗下Fancy Bear。主要使用鱼叉式钓鱼附件（武器化文档）瞄准政府、军事和媒体机构。",
    c_lazarus_t: "Lazarus痕迹", c_lazarus_m: "朝鲜侦察总局关联组织。有通过针对金融机构和加密货币交易所的鱼叉式钓鱼窃取数亿美元的记录。",
    c_c2_t: "C2通道", c_c2_m: "Command & Control——宏执行后受感染PC与攻击者服务器通信的隐蔽通道。伪装为正常的HTTP/HTTPS/DNS流量。",
    c_gateway_t: "邮件网关", c_gateway_m: "在邮件服务器前端过滤垃圾邮件、钓鱼和恶意附件的第一道防线。执行URL重写和附件扫描。",
    c_sandbox_t: "沙箱", c_sandbox_m: "在隔离的虚拟环境中执行可疑附件，安全观察和分析恶意行为（文件创建、注册表修改、C2通信）。",
    c_training_t: "用户培训", c_training_m: "技术防御的最后关卡是'人'。通过钓鱼模拟训练和安全意识教育培养举报可疑邮件的文化。",
    p1_title: "邮件传输的核心", p1_desc: "互联网上<b>发送电子邮件的核心协议</b>名称是什么？",
    p1_opts: ["POP3", "SMTP", "FTP", "HTTP"],
    p2_title: "第一道认证防护", p2_desc: "将<b>发送域DNS中注册的允许IP列表</b>与实际发件IP比对以检测伪造的电子邮件认证技术是？",
    p2_opts: ["SPF", "SSL", "SSH", "SNMP"],
    p3_title: "文档中隐藏的武器", p3_desc: "隐藏在Word/Excel等<b>文档文件中，点击'启用内容'时自动执行的恶意脚本</b>是？",
    p3_opts: ["JavaScript", "CSS", "VBA宏", "HTML"],
    p4_title: "供应链攻击的幕后", p4_desc: "2020年<b>被指为SolarWinds供应链攻击幕后的俄罗斯APT组织</b>是？",
    p4_opts: ["APT28", "APT29", "Lazarus", "APT41"],
    p5_title: "安全分析环境", p5_desc: "在<b>隔离的虚拟环境中安全执行和分析可疑附件的恶意行为的技术</b>是？",
    p5_opts: ["防火墙", "IDS", "沙箱", "VPN"],
    ...
    rTab1: "1. SMTP与邮件传输", rTab2: "2. 电子邮件认证", rTab3: "3. 附件与宏",
    rTab4: "4. APT组织策略", rTab5: "5. 多层防御体系", rTab6: "6. 训练结业",
    r1_h: "SMTP与邮件传输",
    r1_ch1: "第1章 SMTP协议",
    r1_ch1_p: '学习电子邮件传输核心<span class="text-white bg-white/10 px-1 rounded">SMTP(Simple Mail Transfer Protocol)</span>的工作原理。了解从发送MTA到接收MTA的邮件传递过程以及端口25/587的作用。',
    r1_ch2: "第2章 邮件路由",
    r1_ch2_l1: '电子邮件经过多个<span class="text-white bg-white/10 px-1 rounded">中继(Relay)服务器</span>到达目的地。',
    r1_ch2_l2: "每个经由服务器在Received头部留下记录，黑客利用开放中继隐藏发送源。",
    r2_h: "电子邮件认证",
    r2_ch3: "第3章 SPF (Sender Policy Framework)",
    r2_ch3_p: '在发送域的DNS TXT记录中注册<span class="text-white bg-white/10 px-1 rounded">允许的发件IP列表</span>，接收服务器将实际发件IP与之比对以检测伪造。',
    r2_ch4: "第4章 DKIM与DMARC",
    r2_ch4_l1: '<span class="text-white bg-white/10 px-1 rounded">DKIM</span>由发送服务器为邮件添加数字签名，检测传输中的篡改。',
    r2_ch4_l2: '<span class="text-white bg-white/10 px-1 rounded">DMARC</span>综合SPF+DKIM结果应用reject/quarantine/none策略。',
    r3_h: "附件与宏",
    r3_ch5: "第5章 MIME结构",
    r3_ch5_p: '<span class="text-white bg-white/10 px-1 rounded">MIME(Multipurpose Internet Mail Extensions)</span>定义邮件正文类型和附件边界。Base64编码将二进制文件转换为文本进行传输。',
    r3_ch6: "第6章 VBA宏的危险",
    r3_ch6_l1: '黑客在Word/Excel文档中插入<span class="text-white bg-white/10 px-1 rounded">VBA宏</span>，点击\'启用内容\'时执行恶意代码。',
    r3_ch6_l2: "宏充当下载器，从外部C2服务器下载额外的有效载荷。",
    r4_h: "APT组织策略",
    r4_ch7: "第7章 APT28与APT29",
    r4_ch7_p: '俄罗斯情报机构关联组织：<span class="text-white bg-white/10 px-1 rounded">APT28(Fancy Bear)</span>瞄准政府/军事机构，<span class="text-white bg-white/10 px-1 rounded">APT29(Cozy Bear)</span>瞄准外交/能源领域，使用武器化文档附件进行鱼叉式钓鱼。',
    r4_ch8: "第8章 Lazarus的鱼叉式钓鱼",
    r4_ch8_l1: '朝鲜关联的<span class="text-white bg-white/10 px-1 rounded">Lazarus组织</span>瞄准金融机构和加密货币交易所。',
    r4_ch8_l2: "他们通过伪装成招聘邀请、投资报告等业务文档的鱼叉式钓鱼窃取了数亿美元。",
    r5_h: "多层防御体系",
    r5_ch9: "第9章 网关与沙箱",
    r5_ch9_p: '<span class="text-white bg-white/10 px-1 rounded">邮件网关</span>在服务器前端过滤垃圾邮件和恶意附件，<span class="text-white bg-white/10 px-1 rounded">沙箱</span>在隔离的虚拟环境中执行可疑文件以观察恶意行为。',
    r5_ch10: "第10章 用户培训",
    r5_ch10_l1: '技术防御的最后关卡是<span class="text-white bg-white/10 px-1 rounded">人</span>。定期实施钓鱼模拟训练。',
    r5_ch10_l2: "培养立即举报可疑邮件的安全文化，养成不随意点击'启用内容'按钮的习惯。",
    r6_title: "训练结业！",
    r6_desc: "从SMTP传输到电子邮件认证、<br/>宏分析、APT追踪和多层防御<br/>——你已精通鱼叉式钓鱼的一切。",
    r6_grade: "最终评级：",
    r6_labBtn: "前往实验室 🚀",
    r6_freeHint: "(关闭此窗口可自由重新探索各区域)",
  },
  hi: {
    loc1: 'Sector 1: मेल सर्वर रूम', loc2: 'Sector 2: प्रमाणीकरण प्रयोगशाला', loc3: 'Sector 3: अटैचमेंट विश्लेषण कक्ष', loc4: 'Sector 4: APT ट्रैकिंग रूम', loc5: 'Sector 5: रक्षा कमांड सेंटर',
    d1_1: "अहम! एजेंट {AGENT}, आज का मिशन स्पियर फ़िशिंग हमले की पूरी संरचना को समझना है। पहले जानना होगा कि ईमेल कैसे भेजे जाते हैं।",
    d1_2: "जी, टीम लीडर! यह मेल सर्वर रूम है। मैंने सुना है कि SMTP प्रोटोकॉल ईमेल ट्रांसमिशन का मुख्य माध्यम है।",
    d1_3: "सही। हैकर्स SMTP चैनल का दुरुपयोग करके दुर्भावनापूर्ण अटैचमेंट वाले ईमेल भेजते हैं। मेल डिलीवरी प्रक्रिया के 3 प्रमुख सुराग इकट्ठा करो!",
    d2_1: "मिल गए! ईमेल SMTP सर्वर से शुरू होकर कई रिले सर्वरों से गुज़रकर प्राप्तकर्ता तक पहुँचते हैं।",
    d2_2: "बहुत अच्छा। अब इस डिलीवरी प्रक्रिया में उपयोग किए जाने वाले मुख्य प्रोटोकॉल का नाम बताओ।",
    d3_1: "ईमेल ट्रांसमिशन का रास्ता जान लिया, अब 'नकली प्रेषकों' को फ़िल्टर करने वाली प्रमाणीकरण प्रणाली देखते हैं।",
    d3_2: "प्रेषक का पता जाली बनाया जा सकता है? तो किसने भेजा यह कैसे पता चलेगा?",
    d3_3: "यहीं SPF, DKIM, DMARC तीन स्तरीय प्रमाणीकरण ढाल काम आती है। इस लैब में प्रत्येक प्रमाणीकरण तकनीक के सुराग प्राप्त करो!",
    d4_1: "स्कैन पूरा! SPF प्रेषक IP की जाँच करता है, DKIM ईमेल सामग्री की अखंडता सत्यापित करता है, और DMARC दोनों को मिलाकर निर्णय देता है।",
    d4_2: "बिल्कुल सही। अब प्रेषक डोमेन के IP को सत्यापित करने वाली पहली ढाल का नाम बताओ।",
    d5_1: "प्रमाणीकरण पास करने के बाद भी ईमेल के 'अंदर' हथियार छिपे हो सकते हैं। अटैचमेंट की आंतरिक संरचना का विश्लेषण करें।",
    d5_2: "इस विश्लेषण कक्ष में MIME हेडर, Base64 एन्कोडेड अटैचमेंट, और... दस्तावेज़ में छिपे VBA मैक्रो दिख रहे हैं!",
    d5_3: "हाँ, हैकर्स Word और Excel दस्तावेज़ों में दुर्भावनापूर्ण VBA मैक्रो डालते हैं। अटैचमेंट संरचना को पूरी तरह विश्लेषित करो!",
    d6_1: "साक्ष्य सुरक्षित! मैक्रो सक्रिय होने पर बाहरी सर्वर से अतिरिक्त मैलवेयर डाउनलोड होता है।",
    d6_2: "बिल्कुल यही। दस्तावेज़ फ़ाइलों में छिपकर स्वतः निष्पादित होने वाली दुर्भावनापूर्ण स्क्रिप्ट का सटीक नाम बताओ।",
    d7_1: "अब इन हथियारों का वास्तव में उपयोग करने वालों की पहचान करनी होगी। ये राज्य-प्रायोजित APT समूह हैं।",
    d7_2: "APT28 (रूस), Lazarus (उत्तर कोरिया)... ये वे समूह हैं जो स्पियर फ़िशिंग अटैचमेंट का बार-बार उपयोग करते हैं!",
    d7_3: "वे लक्ष्य के कार्य वातावरण की गहन जाँच करके अनुकूलित फ़िशिंग ईमेल भेजते हैं। C2 चैनल को ट्रैक करके सुराग प्राप्त करो!",
    d8_1: "ट्रैकिंग पूरी! प्रत्येक APT समूह द्वारा विशिष्ट उद्योगों और देशों को सटीक निशाना बनाने का पैटर्न पकड़ लिया है।",
    d8_2: "अच्छा। SolarWinds सप्लाई चेन हैक के पीछे बताए गए रूसी APT समूह का नाम सटीक रूप से बताओ।",
    d9_1: "दुश्मन की सभी रणनीतियाँ पहचान ली गई हैं। अब {LEADER} के संगठन की सुरक्षा के लिए बहुस्तरीय रक्षा प्रणाली बनानी होगी!",
    d9_2: "सही! मेल गेटवे से पहली फ़िल्टरिंग, सैंडबॉक्स में संदिग्ध फ़ाइलों का सुरक्षित विश्लेषण, और उपयोगकर्ता प्रशिक्षण से अंतिम रक्षा पंक्ति!",
    d10_1: "सभी रक्षा प्रणालियाँ सक्रिय! गेटवे, सैंडबॉक्स और कर्मचारी प्रशिक्षण — तिहरी रक्षा पंक्ति कार्यरत है।",
    d10_2: "रुको, संदिग्ध फ़ाइलों को पृथक आभासी वातावरण में सुरक्षित रूप से निष्पादित और विश्लेषित करने वाली तकनीक का नाम अंतिम बार पुष्टि करता हूँ।",
    d11_1: "उत्कृष्ट, {AGENT}। SMTP से लेकर प्रमाणीकरण, मैक्रो, APT और बहुस्तरीय रक्षा तक — तुमने स्पियर फ़िशिंग की हर बात में महारत हासिल कर ली।",
    d11_2: "धन्यवाद, {LEADER}! आज की सीख को केस नोटबुक में दर्ज करूँगा।",
    h1: "मेल भेजने वाला SMTP सर्वर, फ़ॉरवर्ड करने वाला रिले सर्वर,<br>और संचार में उपयोग होने वाले पोर्ट नंबर खोजो।",
    h2: "प्रेषक IP सत्यापित करने वाला SPF रिकॉर्ड, डिजिटल हस्ताक्षर जाँचने वाला DKIM,<br>और नीति निर्धारित करने वाला DMARC खोजो।",
    h3: "ईमेल संरचना परिभाषित करने वाला MIME हेडर, दस्तावेज़ में छिपा VBA मैक्रो,<br>और अटैचमेंट रूपांतरित करने वाला Base64 एन्कोडिंग खोजो।",
    h4: "रूस के APT28 की जानकारी, उत्तर कोरिया के Lazarus के निशान,<br>और संक्रमण के बाद कमांड प्राप्त करने वाला C2 चैनल खोजो।",
    h5: "दुर्भावनापूर्ण मेल फ़िल्टर करने वाला मेल गेटवे, संदिग्ध फ़ाइलों का विश्लेषण करने वाला सैंडबॉक्स,<br>और मानवीय निर्णय क्षमता विकसित करने वाला उपयोगकर्ता प्रशिक्षण खोजो।",
    c_smtp_t: "SMTP सर्वर", c_smtp_m: "Simple Mail Transfer Protocol — ईमेल को प्रेषक से प्राप्तकर्ता सर्वर तक पहुँचाने वाला मुख्य प्रोटोकॉल। पोर्ट 25 (डिफ़ॉल्ट) और 587 (सुरक्षित ट्रांसमिशन) का उपयोग करता है।",
    c_relay_t: "मेल रिले", c_relay_m: "ईमेल प्रेषक MTA से प्राप्तकर्ता MTA तक कई रिले(Relay) सर्वरों से गुज़रते हैं। प्रत्येक सर्वर Received हेडर में ट्रांज़िट रिकॉर्ड छोड़ता है।",
    c_port_t: "पोर्ट 25/587", c_port_m: "SMTP डिफ़ॉल्ट रूप से पोर्ट 25 का उपयोग करता है, और STARTTLS एन्क्रिप्टेड ट्रांसमिशन के लिए पोर्ट 587। हैकर्स ओपन रिले का दुरुपयोग कर सकते हैं।",
    c_spf_t: "SPF रिकॉर्ड", c_spf_m: "Sender Policy Framework — प्रेषक डोमेन के DNS में पंजीकृत अनुमत IP सूची की वास्तविक प्रेषक IP से तुलना करके जालसाज़ी का पता लगाता है।",
    c_dkim_t: "DKIM हस्ताक्षर", c_dkim_m: "DomainKeys Identified Mail — प्रेषक सर्वर ईमेल में डिजिटल हस्ताक्षर जोड़ता है, और प्राप्तकर्ता DNS सार्वजनिक कुंजी से अखंडता सत्यापित करता है।",
    c_dmarc_t: "DMARC नीति", c_dmarc_m: "Domain-based Message Authentication — SPF और DKIM परिणामों को मिलाकर reject/quarantine/none नीति लागू करता है और रिपोर्ट बनाता है।",
    c_mime_t: "MIME हेडर", c_mime_m: "Multipurpose Internet Mail Extensions — ईमेल बॉडी प्रकार, अटैचमेंट सीमा(boundary) और एन्कोडिंग विधि परिभाषित करने वाली संरचना।",
    c_vba_t: "VBA मैक्रो", c_vba_m: "Visual Basic for Applications — Word/Excel दस्तावेज़ों में एम्बेडेड स्क्रिप्ट जो 'Enable Content' क्लिक करने पर स्वतः निष्पादित होती है। हैकर्स के पसंदीदा प्रारंभिक प्रवेश वेक्टरों में से एक।",
    c_base64_t: "Base64 एन्कोडिंग", c_base64_m: "बाइनरी अटैचमेंट को SMTP ट्रांसमिशन के लिए टेक्स्ट में बदलने वाली एन्कोडिंग विधि। दुर्भावनापूर्ण फ़ाइलें भी इस प्रारूप में ईमेल में शामिल होती हैं।",
    c_apt28_t: "APT28 जानकारी", c_apt28_m: "रूसी GRU का Fancy Bear। सरकारी, सैन्य और मीडिया संगठनों को लक्षित करके मुख्य रूप से स्पियर फ़िशिंग अटैचमेंट (हथियारबंद दस्तावेज़) का उपयोग करता है।",
    c_lazarus_t: "Lazarus के निशान", c_lazarus_m: "उत्तर कोरियाई RGB से जुड़ा समूह। वित्तीय संस्थानों और क्रिप्टोकरेंसी एक्सचेंजों को लक्षित स्पियर फ़िशिंग से करोड़ों डॉलर चुराने का इतिहास।",
    c_c2_t: "C2 चैनल", c_c2_m: "Command & Control — मैक्रो निष्पादन के बाद संक्रमित PC द्वारा हमलावर के सर्वर से संवाद करने का गुप्त चैनल। सामान्य HTTP/HTTPS/DNS ट्रैफ़िक के रूप में छिपा होता है।",
    c_gateway_t: "मेल गेटवे", c_gateway_m: "मेल सर्वर के सामने स्पैम, फ़िशिंग और दुर्भावनापूर्ण अटैचमेंट फ़िल्टर करने वाली पहली रक्षा पंक्ति। URL पुनर्लेखन और अटैचमेंट स्कैनिंग करता है।",
    c_sandbox_t: "सैंडबॉक्स", c_sandbox_m: "संदिग्ध अटैचमेंट को पृथक आभासी वातावरण में निष्पादित करके दुर्भावनापूर्ण व्यवहार (फ़ाइल निर्माण, रजिस्ट्री परिवर्तन, C2 संचार) का सुरक्षित अवलोकन और विश्लेषण।",
    c_training_t: "उपयोगकर्ता प्रशिक्षण", c_training_m: "तकनीकी रक्षा का अंतिम चौकी 'इंसान' है। फ़िशिंग सिमुलेशन ड्रिल और सुरक्षा जागरूकता प्रशिक्षण से संदिग्ध ईमेल रिपोर्ट करने की संस्कृति बनाता है।",
    p1_title: "ईमेल डिलीवरी का मूल", p1_desc: "इंटरनेट पर <b>ईमेल भेजने वाले मुख्य प्रोटोकॉल</b> का नाम क्या है?",
    p1_opts: ["POP3", "SMTP", "FTP", "HTTP"],
    p2_title: "पहली प्रमाणीकरण ढाल", p2_desc: "<b>प्रेषक डोमेन के DNS में पंजीकृत अनुमत IP सूची</b> की वास्तविक प्रेषक IP से तुलना करके जालसाज़ी का पता लगाने वाली ईमेल प्रमाणीकरण तकनीक कौन सी है?",
    p2_opts: ["SPF", "SSL", "SSH", "SNMP"],
    p3_title: "दस्तावेज़ में छिपा हथियार", p3_desc: "Word/Excel जैसी <b>दस्तावेज़ फ़ाइलों में छिपी 'Enable Content' क्लिक करने पर स्वतः निष्पादित होने वाली दुर्भावनापूर्ण स्क्रिप्ट</b> क्या है?",
    p3_opts: ["JavaScript", "CSS", "VBA मैक्रो", "HTML"],
    p4_title: "सप्लाई चेन हैक के पीछे", p4_desc: "2020 में <b>SolarWinds सप्लाई चेन हैक के पीछे बताए गए रूसी APT समूह</b> का नाम क्या है?",
    p4_opts: ["APT28", "APT29", "Lazarus", "APT41"],
    p5_title: "सुरक्षित विश्लेषण वातावरण", p5_desc: "संदिग्ध अटैचमेंट को <b>पृथक आभासी वातावरण में सुरक्षित रूप से निष्पादित और विश्लेषित करने वाली तकनीक</b> क्या है?",
    p5_opts: ["फ़ायरवॉल", "IDS", "सैंडबॉक्स", "VPN"],
    ...
    rTab1: "1. SMTP और ईमेल डिलीवरी", rTab2: "2. ईमेल प्रमाणीकरण", rTab3: "3. अटैचमेंट और मैक्रो",
    rTab4: "4. APT समूह रणनीतियाँ", rTab5: "5. बहुस्तरीय रक्षा", rTab6: "6. प्रशिक्षण समापन",
    r1_h: "SMTP और ईमेल डिलीवरी",
    r1_ch1: "अध्याय 1. SMTP प्रोटोकॉल",
    r1_ch1_p: 'ईमेल डिलीवरी के मूल <span class="text-white bg-white/10 px-1 rounded">SMTP (Simple Mail Transfer Protocol)</span> के कार्य सिद्धांत सीखें। प्रेषक MTA से प्राप्तकर्ता MTA तक मेल डिलीवरी प्रक्रिया और पोर्ट 25/587 की भूमिका समझें।',
    r1_ch2: "अध्याय 2. मेल रूटिंग",
    r1_ch2_l1: 'ईमेल कई <span class="text-white bg-white/10 px-1 rounded">रिले(Relay) सर्वरों</span> से गुज़रकर गंतव्य तक पहुँचते हैं।',
    r1_ch2_l2: "प्रत्येक ट्रांज़िट सर्वर Received हेडर में रिकॉर्ड छोड़ता है, और हैकर्स उत्पत्ति छिपाने के लिए ओपन रिले का दुरुपयोग करते हैं।",
    r2_h: "ईमेल प्रमाणीकरण",
    r2_ch3: "अध्याय 3. SPF (Sender Policy Framework)",
    r2_ch3_p: 'प्रेषक डोमेन के DNS TXT रिकॉर्ड में <span class="text-white bg-white/10 px-1 rounded">अनुमत प्रेषक IP सूची</span> पंजीकृत करता है, और प्राप्तकर्ता सर्वर जालसाज़ी पहचानने के लिए वास्तविक प्रेषक IP से तुलना करता है।',
    r2_ch4: "अध्याय 4. DKIM और DMARC",
    r2_ch4_l1: '<span class="text-white bg-white/10 px-1 rounded">DKIM</span> ट्रांज़िट में छेड़छाड़ का पता लगाने के लिए ईमेल में डिजिटल हस्ताक्षर जोड़ता है।',
    r2_ch4_l2: '<span class="text-white bg-white/10 px-1 rounded">DMARC</span> SPF+DKIM परिणामों को मिलाकर reject/quarantine/none नीति लागू करता है।',
    r3_h: "अटैचमेंट और मैक्रो",
    r3_ch5: "अध्याय 5. MIME संरचना",
    r3_ch5_p: '<span class="text-white bg-white/10 px-1 rounded">MIME (Multipurpose Internet Mail Extensions)</span> ईमेल बॉडी प्रकार और अटैचमेंट सीमाएँ परिभाषित करता है। Base64 एन्कोडिंग बाइनरी फ़ाइलों को ट्रांसमिशन के लिए टेक्स्ट में बदलती है।',
    r3_ch6: "अध्याय 6. VBA मैक्रो का ख़तरा",
    r3_ch6_l1: 'हैकर्स Word/Excel दस्तावेज़ों में <span class="text-white bg-white/10 px-1 rounded">VBA मैक्रो</span> डालकर \'Enable Content\' क्लिक करने पर दुर्भावनापूर्ण कोड निष्पादित करते हैं।',
    r3_ch6_l2: "मैक्रो बाहरी C2 सर्वरों से अतिरिक्त पेलोड डाउनलोड करने वाले ड्रॉपर का काम करते हैं।",
    r4_h: "APT समूह रणनीतियाँ",
    r4_ch7: "अध्याय 7. APT28 और APT29",
    r4_ch7_p: 'रूसी खुफिया से जुड़े समूह: <span class="text-white bg-white/10 px-1 rounded">APT28 (Fancy Bear)</span> सरकार/सैन्य को, <span class="text-white bg-white/10 px-1 rounded">APT29 (Cozy Bear)</span> कूटनीति/ऊर्जा क्षेत्रों को हथियारबंद दस्तावेज़ अटैचमेंट से लक्षित करता है।',
    r4_ch8: "अध्याय 8. Lazarus का स्पियर फ़िशिंग",
    r4_ch8_l1: 'उत्तर कोरिया से जुड़ा <span class="text-white bg-white/10 px-1 rounded">Lazarus समूह</span> वित्तीय संस्थानों और क्रिप्टोकरेंसी एक्सचेंजों को लक्षित करता है।',
    r4_ch8_l2: "उन्होंने नौकरी प्रस्ताव, निवेश रिपोर्ट जैसे व्यावसायिक दस्तावेज़ों के रूप में छिपे स्पियर फ़िशिंग से करोड़ों डॉलर चुराए हैं।",
    r5_h: "बहुस्तरीय रक्षा",
    r5_ch9: "अध्याय 9. गेटवे और सैंडबॉक्स",
    r5_ch9_p: '<span class="text-white bg-white/10 px-1 rounded">मेल गेटवे</span> सर्वर के सामने स्पैम और दुर्भावनापूर्ण अटैचमेंट फ़िल्टर करता है, <span class="text-white bg-white/10 px-1 rounded">सैंडबॉक्स</span> संदिग्ध फ़ाइलों को पृथक आभासी वातावरण में निष्पादित करके दुर्भावनापूर्ण व्यवहार का अवलोकन करता है।',
    r5_ch10: "अध्याय 10. उपयोगकर्ता प्रशिक्षण",
    r5_ch10_l1: 'तकनीकी रक्षा की अंतिम चौकी <span class="text-white bg-white/10 px-1 rounded">इंसान</span> है। नियमित रूप से फ़िशिंग सिमुलेशन ड्रिल आयोजित करें।',
    r5_ch10_l2: "संदिग्ध ईमेल की तुरंत रिपोर्ट करने की सुरक्षा संस्कृति विकसित करें और 'Enable Content' पर लापरवाही से क्लिक न करने की आदत बनाएँ।",
    r6_title: "प्रशिक्षण पूर्ण!",
    r6_desc: "SMTP डिलीवरी से लेकर ईमेल प्रमाणीकरण,<br/>मैक्रो विश्लेषण, APT ट्रैकिंग और बहुस्तरीय रक्षा तक<br/>— आपने स्पियर फ़िशिंग में महारत हासिल कर ली।",
    r6_grade: "अंतिम ग्रेड:",
    r6_labBtn: "लैब में जाएँ 🚀",
    r6_freeHint: "(प्रत्येक सेक्टर को स्वतंत्र रूप से फिर से खोजने के लिए यह विंडो बंद करें)",
  },
};
